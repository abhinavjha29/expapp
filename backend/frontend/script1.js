...
// try {
//     const response = await axios.get('http://54.208.115.249:3800/getdata') 
...
const response = await axios.post('http://54.208.115.249:3800/user/login',logindetail) ;
if(response.status==200) {
    ...
    window.location.href = 'http://54.208.115.249:3800/expense.html' ;
}
else {
...
async function signuppage(e) {
    e.preventDefault() ;
    window.location.href = 'http://54.208.115.249:3800/index.html'
}
const forgotbtn = document.getElementById('forgotpass') ;
  forgotbtn.addEventListener('click' , async(e)=>{
    console.log(forgotbtn) ;
    e.preventDefault() ;
    window.location.href = 'http://54.208.115.249:3800/forgotpass.html' ;
  })
